...
var StateNavigator = /** @class */ (function () {
    ...
    StateNavigator.prototype.createStateContext = function (state, data, crumbs, url, asyncData, history, currentContext) {
    ...
    StateNavigator.prototype.navigateLink = function (url, historyAction, history, suspendNavigation, currentContext) {
        ...
        var navigateContinuation = function (asyncData) {
            var nextContext = _this.createStateContext(state, data, crumbs, url, asyncData, history, currentContext);
